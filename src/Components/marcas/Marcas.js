...
import { getMarcas, getMarcaById, createMarca, updateMarca, deleteMarca } from '../../services/MarcaService'
...
export default function Marcas() {
          ...
          deleteMarca(id).then((res) => {
            if (res.status === 204) {
              ...
              Swal.fire({
                title: "Error",
                icon: "error",
                text: "Error al aliminar la marca"
              })
            }
          })
        }
  ...
  const editarMarca = async (e) => {
    ...
    try {
      setError(false)
      const resp = await updateMarca(marca._id, marca);
      console.log(resp)
      resetMarca()
      listarMarcas()
    } catch (e) {
        ...
        <div className="modal-dialog">
          <div className="modal-content">
            <div className="modal-header">
              <h5 className="modal-title" id="exampleModal2Label">Editar Tipo de Equipo</h5>
              <button
                type="button"
                className="btn-close"
